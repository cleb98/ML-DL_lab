...
def loss(y_true, y_pred):
    ...
    """
    #è un valore per ogmi esempio, che fatto la media da uno scalare che reappresenta la loss per tutti gli esempi
...
def dloss_dw(y_true, y_pred, X):
    ...
    """
    # @ è il prodotto scalare tra matrici/vettori
...
class LogisticRegression:
    ...
    def predict(self, X):
        ...
        # remove random prections before coding the solution -> np.round prende un valore e lo porta all'intero più vicino
