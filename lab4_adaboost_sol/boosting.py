...
class AdaBoostClassifier:
    ...
    def predict(self, X: np.ndarray):
        ...
        #con questo ciclo associo l a learner 
        for l, learner in enumerate(self.learners): #non è uguale  fare for l  in range(len(self.n_learners))? 
                                                    #no perchè senno come faccio a dirgli di prendere al passo l=1 il classificatore stupido corrispondente
